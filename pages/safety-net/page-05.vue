<template>
  <div>
    <VContainer>
      ...
      <VHeading
        title="Creating Your Buffer for Lumpy Expenses"
    ...
    <VCard>
      ...
      <VButtonBox>
          ...
          <div class="grid grid-cols-2 gap-3">
            <div class="text-left">
              <p class="text-dark-purple text-2xl font-bold">
                {{
                  (safetyNet.bufferForLumpyExpenses.amount -
                    safetyNet.bufferForLumpyExpenses.allocationSavings)
                    | currency
                }}
              </p>
              <p class="text-dark-purple font-semibold">
                You’ll need to top up to fullfill emergency fund
              </p>
            </div>
            <div class="text-left">
              <p class="text-dark-purple text-2xl font-bold">
        ...
        <ButtonContainer>
          <ButtonBack @click="$router.push('/safety-net/page-04')"></ButtonBack>
          <ButtonNext
            :show-icon="false"
            color="blue-dark"
            @click="$router.push('/safety-net/page-06')"
            >NEXT</ButtonNext
          >
        </ButtonContainer>
      </VButtonBox>
